...
config :game_night,
  ...
  ash_domains: [GameNight.Accounts],
...
config :game_night, GameNightWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: GameNightWeb.ErrorHTML, json: GameNightWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: GameNight.PubSub,
  live_view: [signing_salt: "gFC1xSTs"]
