defmodule GameNight.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      # ETS-backed bucket stores for plug_attack. Running them as a
      # supervised child (rather than letting plug_attack create the
      # tables lazily) lets them survive endpoint restarts during dev
      # without losing state.
      {PlugAttack.Storage.Ets,
       name: GameNightWeb.Plugs.VitalsRateLimiter.Storage, clean_period: 60_000},
      {PlugAttack.Storage.Ets,
       name: GameNightWeb.Plugs.AuthRateLimiter.Storage, clean_period: 60_000},
