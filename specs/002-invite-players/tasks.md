...
- [X] T047 [US1] Update `assets/js/routes/games.$id.index.tsx` to render the `<InvitationForm />` in a new "Invite a player" section beneath the game detail. Wires `useCreateInvitation` + toast feedback. Full roster + pending-invitations list lands in US3 (T086).
